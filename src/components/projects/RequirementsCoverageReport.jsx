...
const RequirementsCoverageReport = ({ generatedReport }) => {
    ...
    const { project_id, total_requirements, covered_requirements, coverage_percentage, notcovered_percentage, coverage, project_members } = generatedReport;
    ...
    const handleExportPDF = async () => {
        ...
        // Add Covered Requirements Table
        const coveredRequirementsTable = `
            <div class="section page-break">
                ...
                <div class="table-container">
                    <table>
                        ...
                        <tbody>
                            ${coveredRequirementsList.map(req => `
                                <tr>
        ...
        `;
        exportContent.innerHTML += coveredRequirementsTable;

        // Add Not Covered Requirements Table
        const notCoveredRequirementsTable = `
            <div class="section">
                <h5>Not Covered Requirements</h5>
                <div class="table-container">
                    <table>
                        <thead>
                            <tr>
                        ...
                        <tbody>
                            ${notCoveredRequirementsList.map(req => `
                                <tr>
                                    <td>${req.requirement_id}</td>
                                </tr>
                            `).join('')}
        ...
        `;
        exportContent.innerHTML += notCoveredRequirementsTable;
        ...
        const opt = {
            margin: 1,
            filename: `RequirementsCoverageReport_${project_id}.pdf`,
