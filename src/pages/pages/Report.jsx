...
import RequirementsReport from "../../components/projects/RequirementsReport";
import TestCasesReport from "../../components/projects/TestCasesReport";
import TestPlansReport from "../../components/projects/TestPlansReport";
import TestExecutionsReport from "../../components/projects/TestExecutionsReport";
...
const Report = () => {
    ...
    return (
        <React.Fragment>
            <Helmet title="Requirements Report" />

            <Container fluid className="p-0">
                <h1 className="h3 mb-3">Report</h1>
